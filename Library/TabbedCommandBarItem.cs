...
namespace Library
{
    ...
    public sealed class TabbedCommandBarItem : CommandBar
    {
        ...
        /// </summary>
        private static readonly DependencyProperty IsContextualProperty = DependencyProperty.Register(
            nameof(IsContextual),
            typeof(bool),
            typeof(TabbedCommandBarItem),
        ...
        /// </summary>
        private static readonly DependencyProperty OverflowButtonAlignmentProperty = DependencyProperty.Register(
        ...
        /// </summary>
        private static readonly DependencyProperty CommandAlignmentProperty = DependencyProperty.Register(
